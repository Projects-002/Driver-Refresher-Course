...
<html lang="en">
  <head>
    ...
    <title>Data Defenders Admin aponel</title>
    <meta
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="index.html" class="logo">
              <img
                ...
                height="20"
              />
            <b class="text-light">Admin Dashboard</b>  
            </a>
                  ...
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="maps/jsvectormap.html">
                        <span class="sub-item">Add/Update Course</span>
                      </a>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="charts/charts.html">
                        <span class="sub-item">Detailed</span>
                      </a>
                    </li>
                    <li>
                      <a href="charts/sparkline.html">
                        <span class="sub-item">Summarized</span>
                      </a>
                    </li>
                  </ul>
                </div>
          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">System Anarlytics</h6>
              </div>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          ...
                          <h4 class="card-title">Kshs 1,345</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">Users Licensed</p>
                ...
                <div class="card card-round">
                  <div class="card-body">
                    <div class="card-head-row card-tools-still-right">
                      <div class="card-title">Category A</div>
                      <div class="card-tools">
                        <div class="dropdown">
                          <button
